// Cria os métodos http para cadastrar, atualizar, deletar e listar as máquinas cadastradas
...
const router = express.Router (); // pega a rota a partir da biblioteca Express
...
// Cria o métodoget all - lista todas as máquinas cadastradas
...
router.get ("/:id", async(req, res)=>{
    try{
        const maquina = await Maquina.findBy(req.params.id);
